  ...
  return (
    <div className="min-h-screen relative overflow-hidden flex items-center justify-center bg-slate-950">
      ...
      <div className="relative z-10 w-full max-w-sm mx-4">
        ...
        <div className="relative bg-slate-900 border border-slate-700/50 rounded-2xl p-8 shadow-2xl">
          {/* Logo */}
          <div className="flex flex-col items-center gap-3 mb-8">
            ...
            <div className="text-center">
              <h1 className="text-2xl font-extrabold text-white tracking-tight">StratPulse</h1>
              <p className="text-sm text-slate-400 mt-1">Anticipate the Market. Automate the Response.</p>
            </div>
          </div>
          ...
          <div className="relative flex items-center gap-3 mb-6">
            ...
            <span className="text-xs text-slate-500 font-medium">Sign in to your war room</span>
            <div className="flex-1 h-px bg-slate-700" />
          </div>
          ...
          <div className="space-y-3">
            <button
              ...
              className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-xl
                bg-white hover:bg-slate-50 text-slate-800 font-semibold text-sm
                disabled:opacity-60 disabled:cursor-not-allowed
                transition-all duration-200 hover:shadow-lg hover:shadow-white/10 active:scale-[0.98]
